...
export default function AboutContent() {
    ...
    return (
        <div ref={root} className="overflow-hidden">
            {/* 1. HERO SECTION */}
            <section className="about-hero relative py-32 bg-brand-dark text-white overflow-hidden">
                <div className="absolute inset-0 opacity-20 border-b-8 border-accent-yellow">
                    <Image
                ...
                <div className="container mx-auto px-6 relative z-10 about-hero-content">
                    <div className="border-l-8 border-accent-yellow pl-8">
                        <span className="inline-block py-1 px-3 bg-error text-white text-[10px] font-black uppercase tracking-widest mb-6">
                            Est. 1998
                        </span>
                        <h1 className="text-6xl md:text-8xl font-black mb-6 tracking-tighter uppercase italic">
                            The <span className="text-accent-yellow">Power</span> <br /> Behind Progress
                        </h1>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="scroll-animate relative">
                            <div className="absolute -top-6 -left-6 w-32 h-32 bg-accent-yellow -z-10" />
                            <div className="border-t-[12px] border-l-[12px] border-brand-dark p-4">
                                <Image
                                    src="/images/about-team.png"
                                    alt="Legacy"
                                    width={800}
                        ...
                        <div className="scroll-animate space-y-8">
                            <h2 className="text-5xl md:text-7xl font-black text-brand-dark leading-[0.9] uppercase tracking-tighter">
                                Building a <br />
                                <span className="text-accent-yellow bg-brand-dark px-4 inline-block transform -skew-x-6 italic">Heavy Legacy</span>
                            </h2>
                            ...
                            <div className="grid grid-cols-3 gap-6 pt-10 border-t-2 border-slate-100">
                                <div className="text-center">
                                    <div className="text-4xl font-black text-brand-dark mb-1">25+</div>
                                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Years Active</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-black text-brand-dark mb-1">1.2k+</div>
                                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Fleet Size</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-4xl font-black text-brand-dark mb-1">120+</div>
            ...
            {/* 3. VALUES SECTION */}
            <section className="values-grid pt-32 pb-12 bg-surface-light border-b-0">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col mb-20 scroll-animate">
                        <h2 className="text-5xl md:text-7xl font-black text-brand-dark uppercase tracking-tighter italic">Machine <span className="text-accent-yellow">Code</span></h2>
                        <div className="w-24 h-4 bg-accent-yellow mt-4" />
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-1">
                        {values.map((v, i) => (
                            <div key={i} className="scroll-animate p-12 bg-white border-b-8 border-transparent hover:border-accent-yellow hover:bg-brand-dark group transition-all duration-500">
                                <div className="w-16 h-16 bg-accent-yellow flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                                    <v.icon className="w-8 h-8 text-brand-dark" />
                                </div>
                                <h3 className="text-2xl font-black mb-4 text-brand-dark group-hover:text-white uppercase leading-none">{v.title}</h3>
